...
namespace ad
{
	...
	public:
		 ...
		 */
		virtual void log(LogLevel level, STRING_TYPE const &message) = 0;
		 ...
		 * \see logLevel() const
		 * \see log(LogLevel, STRING_TYPE const &)
		 */
		 ...
		 * \param id the ID
		 */
		virtual void setId(STRING_TYPE const &id) = 0;

		/**
		 * \brief Set the logger pattern. 
		 * 
		 * The pattern may contain some keys, that can be set by
		 * #setPatternParam(STRING_TYPE const &. STRING_TYPE) function. Those keys are used to print some
		 ...
		 * \see setPatternParam(STRING_TYPE, STRING_TYPE)
		 */
		virtual void setPattern(STRING_TYPE const &pattern) = 0;
		 ...
		 */
		virtual void setPatternParam(STRING_TYPE const &param_key, STRING_TYPE const &param_val) = 0;
		 ...
		 */
		virtual STRING_TYPE id() const = 0;

		/**
		 * \brief Get the logger pattern.
		 * \return the logger pattern as c_str
		 */
		virtual STRING_TYPE pattern() const = 0;
		 ...
		 */
		virtual STRING_TYPE param(STRING_TYPE const &param_key) const = 0;
		 ...
		 */
		virtual MAP_TYPE paramList() const = 0;
	};
}
